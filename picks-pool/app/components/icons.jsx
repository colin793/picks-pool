...
export const Icon = {
  share: (p) => (
    <svg {...base} width={16} height={16} {...p}><path d="M12 3v13M7 8l5-5 5 5M5 13v6a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6" /></svg>
  ),
  chat: (p) => (
    <svg {...base} {...p}><path d="M21 12a8 8 0 0 1-11.6 7.1L4 21l1.9-4.6A8 8 0 1 1 21 12z" /></svg>
  ),
  picks: (p) => (
