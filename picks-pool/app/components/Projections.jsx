...
export default function Projections({ games, entries, picks, names, me, draws = false, homeFirst = false, scoring = 'straight', lock = false }) {
  const p = projections(games, entries, picks, { me, draws, scoring, lock });
